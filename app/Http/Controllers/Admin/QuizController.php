    ...
    public function update(Request $request, $id)
{
    ...
    //     foreach ($data as $row) {
    //         // Giả sử thứ tự cột trong file CSV là:
    //         // 'title', 'info', 'url', 'section', 'group_title', 'group_info', 'question_order', 'question_content', 'question_mean', 'answer', 'is_correct'
    //         if (!empty($row[0])) {
    ...
    //                     'creator_id' => auth()->id(),
    //                     'created_at' => time(), // Thêm giá trị created_at
    //                 ]
    //             );
    //         }
    ...
    //                     'created_at' => time(), // Thêm giá trị created_at
    //                     'updated_at' => time(), // Thêm giá trị updated_at
    //                 ]
    //             );
    //         }
    ...
    //                 ['content' => $row[13]],
    //                 [
    //                     'is_correct' => strtolower($row[14]) === 'true' ? 1 : 0, // Chuyển đổi giá trị boolean
        ...
        foreach ($data as $row) {
            ...
            if (!empty($row[13])) {
                $answer = Answer::updateOrCreate(
                    ...
                    [
                        'is_correct' => strtolower($row[14]) === 'true' ? 1 : 0, // Xử lý boolean
                        'created_at' => now(),
                        'updated_at' => now(),
                    ]
                );
